...
function ChartWidget() {
  ...
  if (loading) {
    return <div className="bg-white p-4 h-80 rounded-lg shadow-md flex justify-center items-center text-gray-500">Loading chart data...</div>;
  }

  if (error) {
    return <div className="bg-red-100 p-4 h-80 rounded-lg shadow-md flex justify-center items-center text-red-700">Error loading chart data.</div>;
  }
