...
function Sidebar({
  ...
  const linkStyle =
    "flex items-center p-2 rounded text-gray-300 hover:bg-slate-700 transition-colors duration-200";
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        <div className="w-24 h-12 bg-gray-700 rounded flex items-center justify-center text-gray-300">
          Logo
        </div>
          ...
          {[
            ...
            <li className="mb-2" key={item.to}>
              <NavLink
                to={item.to}
                className={({ isActive }) =>
                  `${linkStyle} ${isActive ? "bg-blue-700 text-white" : ""}`
                }
